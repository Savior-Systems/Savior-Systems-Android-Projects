# BMI Calculator & BMR Tracker

**BMI Calculator & BMR Tracker** is a highly optimized, offline-first application targeting the "Health & Fitness" category.

## App Overview
Calculate BMI and BMR target metrics with a clean, offline visual scale.
