# Fake Call Rescue Simulator

**Fake Call Rescue Simulator** is a highly optimized, offline-first application targeting the "Utilities" category.

## App Overview
Schedule a fake incoming phone call UI to escape awkward social situations.
